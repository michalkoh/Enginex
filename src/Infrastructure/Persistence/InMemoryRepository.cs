...
namespace Enginex.Infrastructure.Persistence
{
    public class InMemoryRepository : IRepository
    {
        ...
        {
            var foundProduct = this.products.Single(c => c.Id == product.Id);
            var index = this.products.IndexOf(foundProduct);
        ...
        {
            var productToDelete = this.products.SingleOrDefault(c => c.Id == product.Id);
